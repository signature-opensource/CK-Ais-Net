// <copyright file="NmeaAisAssignedModeCommandParser.cs" company="Endjin Limited">
...
namespace Ais.Net
{
    ...
    public readonly ref struct NmeaAisAssignedModeCommandParser
    {
        ...
        /// </summary>
        public uint DestinationMmsiA => this.bits.GetUnsignedInteger(30, 40);

        /// <summary>
        /// Gets the offset from current slot to first assigned slot.
        /// </summary>
        public uint OffsetA => this.bits.GetUnsignedInteger(12, 70);

        /// <summary>
        /// Gets the increment to next assigned slot.
        /// </summary>
        public uint IncrementA => this.bits.GetUnsignedInteger(10, 82);

        /// <summary>
        /// Gets the MMSI number of B destination.
        /// </summary>
        public uint? DestinationMmsiB => this.bits.BitCount >= 122
            ? this.bits.GetUnsignedInteger(30, 92)
            : null;

        /// <summary>
        /// Gets the offset from current slot to first assigned slot.
        /// </summary>
        public uint? OffsetB => this.bits.BitCount >= 134
            ? this.bits.GetUnsignedInteger(12, 122)
            : null;

        /// <summary>
        /// Gets the increment to next assigned slot.
        /// </summary>
        public uint? IncrementB => this.bits.BitCount >= 144
            ? this.bits.GetUnsignedInteger(10, 134)
            : null;
        ...
        /// defined.
        /// </summary>
        public uint? SpareBitsAtEnd => this.bits.BitCount == 96
            ? this.bits.GetUnsignedInteger(4, 92)
            : null;
    }
}
