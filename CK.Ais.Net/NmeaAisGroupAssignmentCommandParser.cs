// <copyright file="NmeaAisGroupAssignmentCommandParser.cs" company="Endjin Limited">
...
namespace Ais.Net
{
    ...
    public readonly ref struct NmeaAisGroupAssignmentCommandParser
    {
        ...
        /// </summary>
        public int Longitude10thMins1 => this.bits.GetSignedInteger(18, 40);

        /// <summary>
        /// Gets the reported latitude, in units of 1/10 arc minutes.
        /// </summary>
        public int Latitude10thMins1 => this.bits.GetSignedInteger(17, 58);

        /// <summary>
        /// Gets the reported longitude, in units of 1/10 arc minutes.
        /// </summary>
        public int Longitude10thMins2 => this.bits.GetSignedInteger(18, 75);

        /// <summary>
        /// Gets the reported latitude, in units of 1/10 arc minutes.
        /// </summary>
        public int Latitude10thMins2 => this.bits.GetSignedInteger(17, 93);

        /// <summary>
        /// Gets the station type.
        /// </summary>
        public StationType StationType => (StationType)this.bits.GetUnsignedInteger(4, 110);

        /// <summary>
        /// Gets the type of ship and cargo type.
        /// </summary>
        public uint TypeOfShipAndCargoType => this.bits.GetUnsignedInteger(8, 114);

        /// <summary>
        /// Gets the value of the bits in this message for which no standard meaning is currently
        /// defined.
        /// </summary>
        public uint SpareBits122 => this.bits.GetUnsignedInteger(22, 122);

        /// <summary>
        /// Gets the Tx/Rx mode.
        /// </summary>
        public uint TxRxMode => this.bits.GetUnsignedInteger(2, 144);

        /// <summary>
        /// Gets the parameter that commands the respective stations to the reporting interval.
        /// </summary>
        public ReportingInterval ReportInterval => (ReportingInterval)this.bits.GetUnsignedInteger(4, 146);

        /// <summary>
        /// Gets the quiet time.
        /// </summary>
        public uint QuietTime => this.bits.GetUnsignedInteger(4, 150);

        /// <summary>
        /// Gets the value of the bits in this message for which no standard meaning is currently
        /// defined.
        /// </summary>
        public uint SpareBits154 => this.bits.GetUnsignedInteger(22, 154);
    }
}
